...
def _fetch_construction_from_kosis(start_ym, end_ym):
    ...
    # 착공(766969)과 준공(766973) 테이블의 코드가 다름
    type_filters_by_tbl = {
        "DT_MLTM_5387": [  # 착공
        ...
        "DT_MLTM_5373": [  # 준공
            ("아파트", "13102766973B.0006", "13102766973C.0007", "13102766973D.0008"),
            ("전체",   "13102766973B.0002", "13102766973C.0002", "13102766973D.0002"),
        ],
    }

    for tbl_id, category in tables:
        type_filters = type_filters_by_tbl.get(tbl_id, [])
