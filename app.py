...
with main_tab4:
    ...
    VAR_META = pd.DataFrame([
        # 거래결과 > 매매
        {"표시명": "매매 평균가격",           "컬럼명": "평균가격",              "단위": "만원",       "연집계룰": "가중평균(거래량)",          "정상범위": "",      "카테고리": "거래결과>매매",                  "출처": "실거래"},
        {"표시명": "매매 거래량",             "컬럼명": "거래량",                "단위": "건",         "연집계룰": "sum",                       "정상범위": "≥0",   "카테고리": "거래결과>매매",                  "출처": "실거래"},
        {"표시명": "매매 평균단가",           "컬럼명": "평균단가_per_m2",        "단위": "만원/m²",    "연집계룰": "가중평균(거래량)",          "정상범위": "",      "카테고리": "거래결과>매매",                  "출처": "실거래"},
        # 거래결과 > 전세
        {"표시명": "전세 보증금평균",         "컬럼명": "전세_보증금평균",        "단위": "만원",       "연집계룰": "가중평균(전세_거래량)",     "정상범위": "",      "카테고리": "거래결과>전세",                  "출처": "실거래"},
        {"표시명": "전세 거래량",             "컬럼명": "전세_거래량",            "단위": "건",         "연집계룰": "sum",                       "정상범위": "≥0",   "카테고리": "거래결과>전세",                  "출처": "실거래"},
        {"표시명": "전세 보증금단가",         "컬럼명": "전세_보증금단가",        "단위": "만원/m²",    "연집계룰": "가중평균(전세_거래량)",     "정상범위": "",      "카테고리": "거래결과>전세",                  "출처": "실거래"},
        # 거래결과 > 월세
        {"표시명": "월세 보증금평균",         "컬럼명": "월세_보증금평균",        "단위": "만원",       "연집계룰": "가중평균(월세_거래량)",     "정상범위": "",      "카테고리": "거래결과>월세",                  "출처": "실거래"},
        {"표시명": "월세 거래량",             "컬럼명": "월세_거래량",            "단위": "건",         "연집계룰": "sum",                       "정상범위": "≥0",   "카테고리": "거래결과>월세",                  "출처": "실거래"},
        {"표시명": "월세 보증금단가",         "컬럼명": "월세_보증금단가",        "단위": "만원/m²",    "연집계룰": "가중평균(월세_거래량)",     "정상범위": "",      "카테고리": "거래결과>월세",                  "출처": "실거래"},
        {"표시명": "월세 평균",               "컬럼명": "월세_월세평균",          "단위": "만원/월",    "연집계룰": "가중평균(월세_거래량)",     "정상범위": "",      "카테고리": "거래결과>월세",                  "출처": "실거래"},
        # 거래결과 > 임대전체
        {"표시명": "임대전체 보증금평균",     "컬럼명": "임대전체_보증금평균",    "단위": "만원",       "연집계룰": "가중평균(임대전체_거래량)", "정상범위": "",      "카테고리": "거래결과>임대전체",              "출처": "실거래"},
        {"표시명": "임대전체 거래량",         "컬럼명": "임대전체_거래량",        "단위": "건",         "연집계룰": "sum",                       "정상범위": "≥0",   "카테고리": "거래결과>임대전체",              "출처": "실거래"},
        {"표시명": "임대전체 보증금단가",     "컬럼명": "임대전체_보증금단가",    "단위": "만원/m²",    "연집계룰": "가중평균(임대전체_거래량)", "정상범위": "",      "카테고리": "거래결과>임대전체",              "출처": "실거래"},
        {"표시명": "임대전체 월세평균",       "컬럼명": "임대전체_월세평균",      "단위": "만원/월",    "연집계룰": "가중평균(임대전체_거래량)", "정상범위": "",      "카테고리": "거래결과>임대전체",              "출처": "실거래"},
        # 수요 > 인구수요
        {"표시명": "총인구",                  "컬럼명": "총인구",                "단위": "명",         "연집계룰": "last",                      "정상범위": "",      "카테고리": "수요>인구수요",                  "출처": "통계청"},
        # 공급
        {"표시명": "지역내총생산(GRDP)",      "컬럼명": "GRDP",                  "단위": "백만원",     "연집계룰": "last",                      "정상범위": "",      "카테고리": "공급",                           "출처": "통계청"},
        {"표시명": "아파트 인허가",           "컬럼명": "인허가_호수",            "단위": "호",         "연집계룰": "sum",                       "정상범위": "≥0",   "카테고리": "공급",                           "출처": "통계청"},
        # 수요 > 유효수요 > 소득/신용 (국민연금)
        {"표시명": "NPS 가입자수",            "컬럼명": "NPS_가입자수",           "단위": "명",         "연집계룰": "sum(시도집계)",              "정상범위": "≥0",   "카테고리": "수요>유효수요>소득/신용",        "출처": "국민연금"},
        {"표시명": "NPS 1인당고지금액",       "컬럼명": "NPS_1인당고지금액",      "단위": "원",         "연집계룰": "가중평균(가입자수)",         "정상범위": "",      "카테고리": "수요>유효수요>소득/신용",        "출처": "국민연금"},
        {"표시명": "NPS 사업장수",            "컬럼명": "NPS_사업장수",           "단위": "개",         "연집계룰": "sum(시도집계)",              "정상범위": "≥0",   "카테고리": "수요>유효수요>소득/신용",        "출처": "국민연금"},
        {"표시명": "NPS 고용증감",            "컬럼명": "NPS_고용증감",           "단위": "명",         "연집계룰": "sum(시도집계)",              "정상범위": "",      "카테고리": "수요>유효수요>소득/신용",        "출처": "국민연금"},
        # 수요 > 유효수요 > 소득/신용 (BOK 주담대)
        {"표시명": "주담대 잔액",             "컬럼명": "주담대_잔액",            "단위": "십억원",     "연집계룰": "12월값(연말잔액)",           "정상범위": "",      "카테고리": "수요>유효수요>소득/신용",        "출처": "BOK"},
        {"표시명": "주담대 증감률",           "컬럼명": "주담대_증감률",          "단위": "%",          "연집계룰": "12월 전월비",               "정상범위": "",      "카테고리": "수요>유효수요>소득/신용",        "출처": "BOK"},
        {"표시명": "주담대 비중",             "컬럼명": "주담대_비중",            "단위": "%",          "연집계룰": "12월값",                    "정상범위": "0~100", "카테고리": "수요>유효수요>소득/신용",        "출처": "BOK"},
        # 수요 > 유효수요 > 기존자산 (KOSIS)
        {"표시명": "가구 자산평균",           "컬럼명": "가구_자산평균",          "단위": "만원",       "연집계룰": "연간",                      "정상범위": "",      "카테고리": "수요>유효수요>기존자산",         "출처": "KOSIS"},
        {"표시명": "가구 부채평균",           "컬럼명": "가구_부채평균",          "단위": "만원",       "연집계룰": "연간",                      "정상범위": "",      "카테고리": "수요>유효수요>기존자산",         "출처": "KOSIS"},
        {"표시명": "가구 순자산",             "컬럼명": "가구_순자산",            "단위": "만원",       "연집계룰": "연간(자산-부채)",            "정상범위": "",      "카테고리": "수요>유효수요>기존자산",         "출처": "KOSIS"},
        # 수요 > 유효수요 > 소득/신용 (KOSIS)
        {"표시명": "가구 소득평균",           "컬럼명": "가구_소득평균",          "단위": "만원",       "연집계룰": "연간",                      "정상범위": "",      "카테고리": "수요>유효수요>소득/신용",        "출처": "KOSIS"},
        {"표시명": "부채/소득비율(DSR)",      "컬럼명": "DSR",                   "단위": "%",          "연집계룰": "연간(부채/소득×100)",        "정상범위": "",      "카테고리": "수요>유효수요>소득/신용",        "출처": "KOSIS"},
        # 수요 > 유효수요 > 소득/신용 (국세청)
        {"표시명": "근로소득 신고인원",       "컬럼명": "총급여_인원",            "단위": "명",         "연집계룰": "연간(시군구합산)",            "정상범위": "≥0",   "카테고리": "수요>유효수요>소득/신용",        "출처": "국세청"},
        {"표시명": "근로소득 총급여",         "컬럼명": "총급여_금액",            "단위": "백만원",     "연집계룰": "연간(시군구합산)",            "정상범위": "≥0",   "카테고리": "수요>유효수요>소득/신용",        "출처": "국세청"},
        {"표시명": "1인당 평균급여",          "컬럼명": "1인당총급여_백만원",      "단위": "백만원",     "연집계룰": "연간(총급여/인원)",           "정상범위": "",      "카테고리": "수요>유효수요>소득/신용",        "출처": "국세청"},
        {"표시명": "1인당 결정세액",          "컬럼명": "1인당결정세액_백만원",    "단위": "백만원",     "연집계룰": "연간(결정세액/인원)",         "정상범위": "",      "카테고리": "수요>유효수요>소득/신용",        "출처": "국세청"},
        # 시장심리 (KB부동산)
        {"표시명": "KB 매수우위지수",          "컬럼명": "KB_매수우위지수",         "단위": "지수",       "연집계룰": "12월값",                     "정상범위": "0~200", "카테고리": "시장심리",                       "출처": "KB부동산"},
        {"표시명": "KB 매매거래지수",          "컬럼명": "KB_매매거래지수",         "단위": "지수",       "연집계룰": "12월값",                     "정상범위": "0~200", "카테고리": "시장심리",                       "출처": "KB부동산"},
        {"표시명": "KB 전세수급지수",          "컬럼명": "KB_전세수급지수",         "단위": "지수",       "연집계룰": "12월값",                     "정상범위": "0~200", "카테고리": "시장심리",                       "출처": "KB부동산"},
        # 시장심리 (BOK)
        {"표시명": "소비자심리지수(CCSI)",    "컬럼명": "소비자심리지수",          "단위": "지수",       "연집계룰": "12월값",                     "정상범위": "0~200", "카테고리": "시장심리",                       "출처": "BOK"},
        {"표시명": "주택가격전망CSI",         "컬럼명": "주택가격전망CSI",         "단위": "지수",       "연집계룰": "12월값",                     "정상범위": "0~200", "카테고리": "시장심리",                       "출처": "BOK"},
        {"표시명": "기준금리",                "컬럼명": "기준금리",               "단위": "%",          "연집계룰": "12월값",                     "정상범위": "",      "카테고리": "시장심리",                       "출처": "BOK"},
        {"표시명": "CD 91일",                 "컬럼명": "CD_91일",                "단위": "%",          "연집계룰": "12월값",                     "정상범위": "",      "카테고리": "시장심리",                       "출처": "BOK"},
        {"표시명": "국고채 3년",              "컬럼명": "국고채_3년",             "단위": "%",          "연집계룰": "12월값",                     "정상범위": "",      "카테고리": "시장심리",                       "출처": "BOK"},
        {"표시명": "국고채 5년",              "컬럼명": "국고채_5년",             "단위": "%",          "연집계룰": "12월값",                     "정상범위": "",      "카테고리": "시장심리",                       "출처": "BOK"},
        {"표시명": "국고채 10년",             "컬럼명": "국고채_10년",            "단위": "%",          "연집계룰": "12월값",                     "정상범위": "",      "카테고리": "시장심리",                       "출처": "BOK"},
        {"표시명": "전월세전환율",            "컬럼명": "전월세전환율",           "단위": "%",          "연집계룰": "12월값",                     "정상범위": "",      "카테고리": "시장심리",                       "출처": "BOK"},
        {"표시명": "지가변동률",              "컬럼명": "지가변동률",             "단위": "%",          "연집계룰": "연간",                       "정상범위": "",      "카테고리": "시장심리",                       "출처": "BOK"},
        {"표시명": "아파트매매가격지수",      "컬럼명": "아파트매매가격지수",      "단위": "지수",       "연집계룰": "12월값",                     "정상범위": "",      "카테고리": "시장심리",                       "출처": "BOK"},
        {"표시명": "아파트전세가격지수",      "컬럼명": "아파트전세가격지수",      "단위": "지수",       "연집계룰": "12월값",                     "정상범위": "",      "카테고리": "시장심리",                       "출처": "BOK"},
        # 파생지표
        {"표시명": "전세가율",               "컬럼명": "전세가율",              "단위": "%",          "연집계룰": "계산(전세보증금/매매가×100)", "정상범위": "40~80", "카테고리": "파생지표",                       "출처": "파생"},
        {"표시명": "PIR(소득대비주택가격)",    "컬럼명": "PIR",                  "단위": "배",         "연집계룰": "계산(매매가/가구소득)",       "정상범위": "",      "카테고리": "파생지표",                       "출처": "파생"},
        {"표시명": "PIR(NPS기반)",           "컬럼명": "PIR_NPS",              "단위": "배",         "연집계룰": "계산(매매가/NPS연소득)",      "정상범위": "",      "카테고리": "파생지표",                       "출처": "파생"},
        {"표시명": "매매 거래회전율",         "컬럼명": "매매_거래회전율",        "단위": "‰",         "연집계룰": "계산(거래량/인구×1000)",     "정상범위": "",      "카테고리": "파생지표",                       "출처": "파생"},
        {"표시명": "전세 거래회전율",         "컬럼명": "전세_거래회전율",        "단위": "‰",         "연집계룰": "계산(전세거래/인구×1000)",    "정상범위": "",      "카테고리": "파생지표",                       "출처": "파생"},
        {"표시명": "가격변화율(YoY)",        "컬럼명": "가격변화율_YoY",        "단위": "%",          "연집계룰": "계산(전년대비변화)",          "정상범위": "",      "카테고리": "파생지표",                       "출처": "파생"},
        {"표시명": "소득대비대출",           "컬럼명": "소득대비대출",          "단위": "배",         "연집계룰": "계산(주담대/가구소득)",       "정상범위": "",      "카테고리": "파생지표",                       "출처": "파생"},
    ])
