...
with main_tab4:
    ...
    VAR_META = pd.DataFrame([
        ...
        # 국세청 근로소득 (시군구→시도 집계)
        {"표시명": "근로소득 신고인원",       "컬럼명": "총급여_인원",            "단위": "명",         "연집계룰": "연간(시군구합산)",            "정상범위": "≥0"},
        {"표시명": "근로소득 총급여",         "컬럼명": "총급여_금액",            "단위": "백만원",     "연집계룰": "연간(시군구합산)",            "정상범위": "≥0"},
        {"표시명": "1인당 평균급여",          "컬럼명": "1인당총급여_백만원",      "단위": "백만원",     "연집계룰": "연간(총급여/인원)",           "정상범위": ""},
        {"표시명": "1인당 결정세액",          "컬럼명": "1인당결정세액_백만원",    "단위": "백만원",     "연집계룰": "연간(결정세액/인원)",         "정상범위": ""},
        # KB부동산 수급 데이터
        {"표시명": "KB 매수우위지수",          "컬럼명": "KB_매수우위지수",         "단위": "지수",       "연집계룰": "12월값",                     "정상범위": "0~200"},
        {"표시명": "KB 매매거래지수",          "컬럼명": "KB_매매거래지수",         "단위": "지수",       "연집계룰": "12월값",                     "정상범위": "0~200"},
        {"표시명": "KB 전세수급지수",          "컬럼명": "KB_전세수급지수",         "단위": "지수",       "연집계룰": "12월값",                     "정상범위": "0~200"},
        # 소비자심리지수
        {"표시명": "소비자심리지수(CCSI)",    "컬럼명": "소비자심리지수",          "단위": "지수",       "연집계룰": "12월값",                     "정상범위": "0~200"},
        {"표시명": "주택가격전망CSI",         "컬럼명": "주택가격전망CSI",         "단위": "지수",       "연집계룰": "12월값",                     "정상범위": "0~200"},
        # 파생지표
        {"표시명": "전세가율",               "컬럼명": "전세가율",              "단위": "%",          "연집계룰": "계산(전세보증금/매매가×100)", "정상범위": "40~80"},
        {"표시명": "PIR(소득대비주택가격)",    "컬럼명": "PIR",                  "단위": "배",         "연집계룰": "계산(매매가/가구소득)",       "정상범위": ""},
        {"표시명": "PIR(NPS기반)",           "컬럼명": "PIR_NPS",              "단위": "배",         "연집계룰": "계산(매매가/NPS연소득)",      "정상범위": ""},
        {"표시명": "매매 거래회전율",         "컬럼명": "매매_거래회전율",        "단위": "‰",         "연집계룰": "계산(거래량/인구×1000)",     "정상범위": ""},
        {"표시명": "전세 거래회전율",         "컬럼명": "전세_거래회전율",        "단위": "‰",         "연집계룰": "계산(전세거래/인구×1000)",    "정상범위": ""},
        {"표시명": "가격변화율(YoY)",        "컬럼명": "가격변화율_YoY",        "단위": "%",          "연집계룰": "계산(전년대비변화)",          "정상범위": ""},
        {"표시명": "소득대비대출",           "컬럼명": "소득대비대출",          "단위": "배",         "연집계룰": "계산(주담대/가구소득)",       "정상범위": ""},
    ])
